    ...
    <section className="py-16 sm:py-24 md:py-32 px-4 sm:px-8 md:px-16 bg-primary-container text-on-primary" id="contacto">
      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="font-mono text-[10px] tracking-[0.15em] opacity-60 mb-10 md:mb-14">
            Respondemos en menos de 24hs
          </p>

          <div className="flex items-center gap-6">
            <a
              href="https://www.instagram.com/danialv.music/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.youtube.com/@danialvoficial5779"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:opacity-60 transition-opacity"
              aria-label="YouTube"
